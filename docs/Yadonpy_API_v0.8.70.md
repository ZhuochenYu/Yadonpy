...
This release keeps the same public entry points as `v0.8.69`, but the bundled
`OPLSAA()` data now includes the imported `moltemplate` OPLS-AA 2024 parameter
set and an expanded SMARTS rule table for silicon- and ion-containing systems.
