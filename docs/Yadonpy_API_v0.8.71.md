...
### `load_from_moldb(smiles, *, charge="RESP", basis_set=None, method=None, require_ready=True, return_record=False)`
...
`v0.8.71` is the first release where:
...
Future releases may expand charged-group templates and residue-aware analysis helpers, but these features are already part of the intended public workflow model.
