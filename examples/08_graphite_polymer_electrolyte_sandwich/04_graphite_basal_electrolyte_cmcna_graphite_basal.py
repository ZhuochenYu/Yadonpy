...
work_dir = BASE_DIR / "work_dir" / "04_graphite_basal_electrolyte_cmcna_graphite_basal"
...
if __name__ == "__main__":
    ...
    graphite_bottom = GraphiteLayerSpec(name="GRAPHITE_BOTTOM", nx=6, ny=5, n_layers=3, orientation="basal", periodic_xy=True)
    graphite_top = GraphiteLayerSpec(name="GRAPHITE_TOP", nx=6, ny=5, n_layers=3, orientation="basal", periodic_xy=True)
    ...
    stack = LayerStackSpec(
        ...
        order="bottom_to_top",
        pbc_mode="xyz",
        name="graphite_basal_electrolyte_cmcna_graphite_basal",
        default_gap_nm=0.35,
    )
